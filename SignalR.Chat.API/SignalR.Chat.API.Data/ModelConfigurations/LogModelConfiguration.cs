using System;
using SignalR.Chat.API.Data.ModelConfigurations.Base;
using SignalR.Chat.API.Entities;
using Microsoft.EntityFrameworkCore.Metadata.Builders;

namespace SignalR.Chat.API.Data.ModelConfigurations
{
    /// <summary>
    ...
    public class LogModelConfiguration : IdentityModelConfigurationBase<Log>
    {
        protected override void AddBuilder(EntityTypeBuilder<Log> builder)
        {
            ...
            builder.Property(x => x.CreatedAt).HasConversion(v => v, v => DateTime.SpecifyKind(v, DateTimeKind.Utc))
                .IsRequired();
