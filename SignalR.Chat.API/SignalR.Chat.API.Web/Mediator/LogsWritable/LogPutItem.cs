...
namespace SignalR.Chat.API.Web.Mediator.LogsWritable
{
    ...
    public class LogPutItemRequestHandler : OperationResultRequestHandlerBase<LogPutItemRequest, LogViewModel>
    {
        ...
        public override async Task<OperationResult<LogViewModel>> Handle(LogPutItemRequest request,
            CancellationToken cancellationToken)
        {
            ...
            var entity =
                await repository.GetFirstOrDefaultAsync(predicate: x => x.Id == request.Model.Id,
