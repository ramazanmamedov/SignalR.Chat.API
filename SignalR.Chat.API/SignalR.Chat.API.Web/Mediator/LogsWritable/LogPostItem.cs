...
namespace SignalR.Chat.API.Web.Mediator.LogsWritable
{
    /// <summary>
    ...
    public class LogPostItemRequestHandler : OperationResultRequestHandlerBase<LogPostItemRequest, LogViewModel>
    {
        ...
        public LogPostItemRequestHandler(IUnitOfWork unitOfWork, IMapper mapper,
            ILogger<LogPostItemRequestHandler> logger)
        {
        ...
        public override async Task<OperationResult<LogViewModel>> Handle(LogPostItemRequest request,
