...
namespace SignalR.Chat.API.Web.Mediator.LogsReadonly
{
    /// <summary>
    /// Request for paged list of Logs
    /// </summary>
    public record LogGetPagedRequest
        (PagedListQueryParams QueryParams) : OperationResultRequestBase<IPagedList<LogViewModel>>;

    /// <summary>
    /// Request for paged list of Logs
    /// </summary>
    public class
        LogGetPagedRequestHandler : OperationResultRequestHandlerBase<LogGetPagedRequest, IPagedList<LogViewModel>>
    {
