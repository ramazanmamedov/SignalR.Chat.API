...
namespace SignalR.Chat.API.Web.Infrastructure.Auth
{
    /// <summary>
    ...
    public sealed class IdentityHelper
    {
        ...
        public void Configure(IHttpContextAccessor httpContextAccessor)
        {
            ContextAccessor = httpContextAccessor ??
                              throw new MicroserviceArgumentNullException(nameof(IHttpContextAccessor));
            IsInitialized = true;
        }
        ...
        public IIdentity? User
        {
            get
            {
                ...
                throw new MicroserviceArgumentNullException(
                    $"{nameof(IdentityHelper)} has not been initialized. Please use {nameof(IdentityHelper)}.Instance.Configure(...) in Configure Application method in Startup.cs");
            }
        }
