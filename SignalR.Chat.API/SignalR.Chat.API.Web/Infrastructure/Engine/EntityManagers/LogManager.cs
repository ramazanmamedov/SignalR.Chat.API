...
namespace SignalR.Chat.API.Web.Infrastructure.Engine.EntityManagers
{
    /// <summary>
    ...
    {
        /// <inheritdoc />
        public LogManager(IMapper mapper, IViewModelFactory<LogCreateViewModel, LogUpdateViewModel> viewModelFactory,
            IEntityValidator<Log> validator)
