...
namespace SignalR.Chat.API.Web.Infrastructure.Engine.ViewModelFactories
{
    /// <summary>
    ...
    public class LogViewModelFactory : ViewModelFactory<LogCreateViewModel, LogUpdateViewModel>
    {
        ...
        public override async Task<OperationResult<LogUpdateViewModel>> GenerateForUpdateAsync(Guid id)
        {
            ...
            operation.AddSuccess("ViewModel generated for Log entity. Please see Additional information in DataObject")
